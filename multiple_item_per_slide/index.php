...
<div class="carousel slide row" data-ride="carousel" data-type="multi" data-interval="2000" id="fruitscarousel">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <div class="col-md-3 col-sm-4 col-xs-12">Editor</div>
        </div>
        <div class="item">
            <div class="col-md-3 col-sm-4 col-xs-12">Section Editor</div>
        </div>
        <div class="item">
            <div class="col-md-3 col-sm-4 col-xs-12">Journal Manager</div>
        </div>
        <div class="item">
            <div class="col-md-3 col-sm-4 col-xs-12">Copyeditor</div>
        </div>
        <div class="item">
            <div class="col-md-3 col-sm-4 col-xs-12">Reviewer</div>
        </div>
        <div class="item">
            <div class="col-md-3 col-sm-4 col-xs-12">Author</div>
        </div>
    </div>
